...
$area_data = json_decode(file_get_contents(MYURL.'area/'));
                    ...
                    <table id="table" class="table table-bordered table-striped">
                        ...
                        foreach ( $area_data as $data )
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-default" href="<?php echo 'add_area?id='. $data->id; ?>"><i class="fa fa-pencil"></i></a>
    ...
    $(document).ready(function() {
        ...
        $('.delete').click(function() {
            ...
            $.ajax({
                type: 'post',
                dataType:'json',
                url: '<?php  echo MYURL.'area_remove'; ?>',
                data: {
                    id: delId
                },
