...
if(isset($_GET['id'])) {
	...
	$restaurant_data = json_decode(file_get_contents(MYURL.'getRestaurantById/id/'.$getval));
	...
	<div class="content-wrapper">
        ...
        <!--<form id="addrestaurant" class="form-horizontal" >-->
         ...
         <label class="col-sm-2 control-label">Hotel Name</label>
         	<div class="col-sm-6">
            	<input name="hotelname" class="form-control" type="text" value="<?php echo $res_name; ?>" required placeholder="Name">
<?php if(isset($getval)) { ?>
