...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <tr>
            ...
            <td><?php echo "<img width='100' height='100' src='data:image/jpeg;base64,".$data->logo."'/>" ?></td>
            <td><a data-toggle="modal" href="<?php echo 'view_branch?id='. $data->id; ?>" data-target="#myBranch" class="btn btn-default">View Branch</a></td>
           
            <td>
                <a class="btn btn-default" href="<?php echo 'add_restaurant?id='. $data->id; ?>"><i class="fa fa-pencil"></i></a>
    ...
    $(document).ready(function() {
        ...
        $('.delete').click(function() {
            ...
            $.ajax({
                type: 'post',
                dataType:'json',
                url: '<?php  echo MYURL.'restaurant_remove'; ?>',
                data: {
                    id: delId
                    },
