    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview active">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>Restaurant</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
            ...
            <li class="treeview active">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>Menus</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    ...
                    <!--<li><a href="add_menugroup"><i class="fa fa-circle-o"></i>Add Menu Group</a></li>
                    <li><a href="add_ingredientgroup"><i class="fa fa-circle-o"></i>Add Ingredient Group</a></li>
                    <li><a href="add_ingredient"><i class="fa fa-circle-o"></i>Add Ingredient</a></li>-->
                </ul>
            </li>
            <li>
                <a href="#">
            ...
            <li><a href="../../documentation/index.html"><i class="fa fa-book"></i> <span>Customer Details</span></a></li>
